...
class LessionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lession" do
    assert_difference('Lession.count') do
      post lessions_url, params: { lession: { description: @lession.description, keywords: @lession.keywords, search_field: @lession.search_field, title: @lession.title } }
    end
  ...
  test "should update lession" do
    patch lession_url(@lession), params: { lession: { description: @lession.description, keywords: @lession.keywords, search_field: @lession.search_field, title: @lession.title } }
